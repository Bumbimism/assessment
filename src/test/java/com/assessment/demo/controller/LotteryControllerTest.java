...
class LotteryControllerTest {
    ...
    void showLotteriesSuccess() throws Exception {
        ...
        verify(lotteryApiService).showAllLotteries();
    ...
    void showUserLotteriesSuccess() throws Exception {
        ...
        verify(lotteryApiService).showUserLotteries(userId);
    ...
    void purchaseLotterySuccess() throws Exception {
        ...
        verify(lotteryApiService).purchaseLottery(userId,ticketId);
    ...
    void refundLotterySuccess() throws Exception {
        ...
        verify(lotteryApiService).refundLottery(userId,ticketId);
